...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=UXHW9cX0uBM6BZE4CLfASpsq3Q') //申请key:https://api.nsmao.net
.then(response => {
if (!response.ok) {
...
return;
 ...
 let dist = getDistance(113.364202, 23.135290, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
